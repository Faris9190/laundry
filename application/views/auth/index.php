<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">Bunda Laundry</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      <img src="<?= base_url(); ?>assets/img/img_properties/icon.png" alt="logo" class="img-fluid rounded mb-2" width="200">
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">Bunda Laundry</h1>
      ...
      <h5 class="text-shadow my-2">Namanya juga hidup pasti banyak <span class="font-weight-bold">Cobaan</span>, kalo banyak <span class="font-weight-bold">Cucian</span> bawa aja ke <span class="font-weight-bold oleo-font">Bunda Laundry.</span></h5>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">Bunda Laundry</h3>
		    	<div class="row">
		    		<div class="col-lg">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-5"><a class="text-white" target="_blank" href="https://api.whatsapp.com/send?phone=+6281222334545">+62 815 8607 8776</a></div>
        </div>
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8">Jl. Kinanti Blok G3 No.11, Tanah Baru, Bogor</div>
        </div>
      </div>
		</div>
		<div class="row">
			<div class="col-lg">
				<iframe class="rounded" <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d990.93510874087!2d106.8235857472525!3d-6.554417325534489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5b7ad0f824b%3A0x4c71fd1b0b8ae76d!2sKota%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1692159225367!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" height="300" frameborder="0" style="border:0; margin-top: 15px;width: 100%"></iframe>
			</div>
		</div>
	</div>
</footer>
